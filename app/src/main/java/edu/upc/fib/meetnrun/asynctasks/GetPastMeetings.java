...
public abstract class GetPastMeetings extends AsyncTask<Integer, Integer, List<Meeting> > implements AsyncTaskCallbackMeetings,AsyncTaskException {
    ...
    protected void onPostExecute(List<Meeting> meetings) {
        if (exception == null) onResponseReceived(meetings);
